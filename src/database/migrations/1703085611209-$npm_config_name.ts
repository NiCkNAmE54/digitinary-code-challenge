...
export class  $npmConfigName1703085611209 implements MigrationInterface {
    name = ' $npmConfigName1703085611209'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`pokemon\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`pokedexNumber\` int NOT NULL, \`imgName\` varchar(255) NOT NULL, \`generation\` int NOT NULL, \`evolutionStage\` int NOT NULL, \`evolved\` tinyint NOT NULL, \`familyId\` int NOT NULL, \`crossGen\` tinyint NOT NULL, \`statTotal\` int NOT NULL, \`attack\` int NOT NULL, \`defense\` int NOT NULL, \`stamina\` int NOT NULL, \`legendary\` tinyint NOT NULL, \`acquireable\` tinyint NOT NULL, \`spawns\` tinyint NOT NULL, \`regional\` tinyint NOT NULL, \`raidable\` tinyint NOT NULL, \`hatchable\` tinyint NOT NULL, \`shiny\` tinyint NOT NULL, \`nest\` tinyint NOT NULL, \`isNew\` tinyint NOT NULL, \`notGettable\` tinyint NOT NULL, \`futureEvolve\` tinyint NOT NULL, \`cpAt40\` int NOT NULL, \`cpAt39\` int NOT NULL, \`type1Id\` int NULL, \`type2Id\` int NULL, \`weather1Id\` int NULL, \`weather2Id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
